// signal_timer.cpp : 定义控制台应用程序的入口点。
//
...
typedef ACE_Async_Timer_Queue_Adapter<ACE_Timer_Heap> AsyncTimer; 
#elif defined(USE_LIST_IMPL)
#include "ace/Timer_List.h" 
typedef ACE_Async_Timer_Queue_Adapter<ACE_Timer_List> AsyncTimer; 
#elif defined(USE_WHEEL_IMPL)
#include "ace/Timer_Wheel.h" 
typedef ACE_Async_Timer_Queue_Adapter<ACE_Timer_Wheel> AsyncTimer; 
#elif defined(USE_HASH_HEAP_IMPL)
#include "ace/Timer_Hash.h" 
typedef ACE_Async_Timer_Queue_Adapter<ACE_Timer_Hash_Heap> AsyncTimer; 
#elif defined(USE_HASH_LIST_IMPL)
#include "ace/Timer_Hash.h" 
typedef ACE_Async_Timer_Queue_Adapter<ACE_Timer_Hash> AsyncTimer; 
#endif 
...
int test_timer_queue(AsyncTimer* tq)
{
  int const size = 10; 
  int ids[size] = { 0 }; 
