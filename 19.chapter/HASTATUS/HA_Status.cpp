...
int HA_Status::suspend ()
{
    ACE_DEBUG ((LM_DEBUG, "suspend HA_Status\n")); 
    //return ACE_Service_Object::suspend (); 
    return ACE_Reactor::instance ()->suspend_handler (this); 
}

int HA_Status::resume ()
{
    ACE_DEBUG ((LM_DEBUG, "resume HA_Status\n")); 
    //return ACE_Service_Object::resume (); 
